...
// =========================================================
(function () {
    const HM_PWA_APP_VERSION = 'v1.0-step6-2-13-2';
    const HM_PWA_SW_URL = '/service-worker.js?v=step6-2-13-2-admin-user-directory-permission-safe-20260718';
