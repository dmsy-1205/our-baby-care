...
// =========================================================
(function () {
    const HM_PWA_APP_VERSION = 'v1.0-step6-2-13-1';
    const HM_PWA_SW_URL = '/service-worker.js?v=step6-2-13-1-admin-user-directory-readonly-20260718';
