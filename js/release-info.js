...
(function () {
    const release = Object.freeze({
        product: 'HearMe2nite',
        version: 'v1.0 STEP6.2.14.53',
        appVersion: 'HearMe2nite v1.0 STEP6.2.14.53',
        step: 'STEP6.2.14.53',
        build: '20260723',
        releaseDate: '2026.07.23',
        stage: 'Beta',
        title: '베타 관계 종료·상호 회복 보호',
        description: '관계 종료 시 Dom과 Sub 양쪽의 Room 데이터를 잠그고, 한쪽의 회복 요청을 다른 쪽이 동의해야 기존 기록을 다시 불러올 수 있도록 보호했습니다.',
