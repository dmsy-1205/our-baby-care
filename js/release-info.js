...
(function () {
    const release = Object.freeze({
        product: 'HearMe2nite',
        version: 'v1.0 STEP6.2.14.57',
        appVersion: 'HearMe2nite v1.0 STEP6.2.14.57',
        step: 'STEP6.2.14.57',
        build: '20260723',
        releaseDate: '2026.07.23',
        stage: 'Beta',
        title: '우리의 공간 연결·관계 관리 위계 개선',
        description: '공간 만들기, 초대, 받은 코드, 이전 공간 이동을 한 블록으로 묶고 관계 종료는 최하단의 작은 관계 관리 영역으로 옮겼습니다. 관계 상태는 서버가 확정한 뒤에만 화면을 전환합니다.',
