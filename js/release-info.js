...
(function () {
    const release = Object.freeze({
        product: 'HearMe2nite',
        version: 'v1.0 STEP6.1.9',
        appVersion: 'HearMe2nite v1.0 STEP6.1.9',
        step: 'STEP6.1.9',
        build: '20260716',
        releaseDate: '2026.07.16',
        stage: 'Beta',
        title: '사용 가이드 한눈에 보기 메뉴 개선',
        description: '사용 가이드의 가로 스크롤 메뉴를 제거하고 PC와 모바일에서 모든 항목을 한눈에 선택할 수 있는 아이콘 메뉴로 개선합니다.',
        changes: Object.freeze([
            '사용 가이드의 가로 스크롤 탭을 한눈에 보이는 아이콘 메뉴 그리드로 교체',
            '모바일 3열·태블릿 4열·PC 6열 배치로 모든 안내 메뉴를 즉시 확인',
            '실제 안내 패널이 없던 메뉴를 제거하고 나의 루틴·테마·데이터 안내 메뉴를 연결',
            '관리자 콘솔 개발을 STEP6.1.8 상태로 동결하고 이번 릴리스에서는 수정하지 않음',
            '중복 STEP·핫픽스 QA Markdown 문서를 정리하고 필수 운영 문서만 유지',
