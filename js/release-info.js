...
(function () {
    const release = Object.freeze({
        product: 'HearMe2nite',
        version: 'v1.0 STEP6.2.14.56',
        appVersion: 'HearMe2nite v1.0 STEP6.2.14.56',
        step: 'STEP6.2.14.56',
        build: '20260723',
        releaseDate: '2026.07.23',
        stage: 'Beta',
        title: '베타 관계 종료 서버 확정·즉시 잠금',
        description: '관계 종료를 서버가 확정한 뒤에만 화면을 전환하고, 실패 시 원래 상태로 복원하며, 성공 시 양쪽의 코멘트·알림·기록 화면을 즉시 닫고 잠급니다.',
