...
(function () {
    const release = Object.freeze({
        product: 'HearMe2nite',
        version: 'v1.0 STEP6.2.14.58',
        appVersion: 'HearMe2nite v1.0 STEP6.2.14.58',
        step: 'STEP6.2.14.58',
        build: '20260723',
        releaseDate: '2026.07.23',
        stage: 'Beta',
        title: '오늘의 요약에 나의 루틴 추가',
        description: '오늘의 요약 설정에서 나의 루틴을 선택하고 완료 개수와 전체 루틴 수를 확인할 수 있습니다.',
