import { getAdminDatabase } from '../admin-api.js?v=admin-2-0-a18-2-beta-safety-deletion-validation-20260721';
import { getState } from '../admin-state.js';
import { asObject, escapeHtml, formatDateTime, compactId } from '../admin-utils.js?v=admin-2-0-a18-2-beta-safety-deletion-validation-20260721';
import { renderEmptyState } from '../components/empty-state.js?v=admin-2-0-a18-2-beta-safety-deletion-validation-20260721';
