...
import { renderTopbar } from './components/topbar.js?v=admin-2-0-a11-route-render-fix-20260719';
import { renderLoadingState } from './components/loading-state.js?v=admin-2-0-a11-route-render-fix-20260719';

const routes = new Set(['dashboard', 'users', 'rooms', 'requests', 'recovery', 'audit', 'releases', 'system']);
const ADMIN_MODULE_VERSION = 'admin-2-0-a11-route-render-fix-20260719';
