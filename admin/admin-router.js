...
const ADMIN_MODULE_VERSION = 'step6-2-13-6-admin-data-requests-actions-20260718';
...
export async function navigate(route, { replace = false } = {}) {
  ...
  try {
    ...
    outlet.innerHTML = `<div class="error-card"><strong>?�면??불러?��? 못했?�니??</strong><p>${error.message}</p></div>`;
  }
}
