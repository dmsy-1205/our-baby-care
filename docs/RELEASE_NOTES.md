...
# HearMe2nite v1.0 STEP5.10.8 릴리스 노트
...
## STEP5.10.8
- 나의 루틴을 오늘의 약속과 같은 입력 카드 구조로 확장
- 텍스트/체크/숫자/시간 항목 지원
- 새 루틴 만들기 버튼을 관리 화면 상단으로 이동
- 관리 목록을 간단한 카드 목록으로 정리
- 기록실 상단과 사진 모아보기 카드의 다크모드 배치 보정
- 로그아웃 중 루틴 리스너 오류 출력 방지
